...
# Find histograms using hist function
hist(action_by_year_filled$x)
hist(sports_by_year_filled$x)
hist(misc_by_year_filled$x)
hist(rpg_by_year_filled$x)
hist(adventure_by_year_filled$x)
hist(racing_by_year_filled$x)
hist(platform_by_year_filled$x)
hist(simulation_by_year_filled$x)
hist(fighting_by_year_filled$x)
hist(strategy_by_year_filled$x)
hist(puzzle_by_year_filled$x)

# Find summary
summary(action_by_year_filled$x)
summary(sports_by_year_filled$x)
summary(misc_by_year_filled$x)
summary(rpg_by_year_filled$x)
summary(adventure_by_year_filled$x)
summary(racing_by_year_filled$x)
summary(platform_by_year_filled$x)
summary(simulation_by_year_filled$x)
